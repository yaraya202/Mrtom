...
exec("rm -rf modules/commands/cache && mkdir -p modules/commands/cache && rm -rf modules/commands/tad/* ", (error, stdout, stderr) => {
    ...
    console.log(chalk.bold.hex("#00ffff")("𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓 (𝙍𝙖𝙩𝙪𝙡 𝙃𝙖𝙨𝙨𝙖𝙣) ❯ ") + chalk.hex("#00ffff")("fixed by 𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓 (𝙍𝙖𝙩𝙪𝙡 𝙃𝙖𝙨𝙨𝙖𝙣)"))
});
...
console.log(chalk.bold.hex("#00ffff").bold("[ 𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓 (𝙍𝙖𝙩𝙪𝙡 𝙃𝙖𝙨𝙨𝙖𝙣) ] » ") + chalk.bold.hex("#00ffff").bold("Initializing variables..."));
...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/MrT0mXxX/MrT0m/main/listban.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/MrT0mXxX/MrT0m/main/listban.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/MrT0mXxX/MrT0m/main/data.json').then(json => {
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓`, '[ 𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓 (𝙍𝙖𝙩𝙪𝙡 𝙃𝙖𝙨𝙨𝙖𝙣) ]');
        logger('Hey, thank you for using this Bot', '[ 𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓 (𝙍𝙖𝙩𝙪𝙡 𝙃𝙖𝙨𝙨𝙖𝙣) ]');
        logger("Fixed by 𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓", '[ 𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓 (𝙍𝙖𝙩𝙪𝙡 𝙃𝙖𝙨𝙨𝙖𝙣) ]');
...
cron.schedule('0 0 6 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodmorning everyone, have a nice day❤️❤️", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 12 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodafternoon humans 😇😇", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 20 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodevening humans, it's already evng, have you all eaten?😕😕", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 24 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodmorning humans, another day another hope☺️☺️ ", now.threadID) : '');
  });
}, {
  scheduled: true,
